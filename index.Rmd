...
b %>%
  ...
  labs(
    y="Total Number of Hours Worked"
  )+
  ylim(0,10)
```
...
### Distribution of Time by Project Across Weeks 
...
a <- data %>%
  ...
  ggplot(aes(week,Hours,fill=Project))+
  geom_col()+
  scale_color_brewer(palette = "Purples")+
  scale_fill_brewer(palette = "Purples")+
  theme_classic(base_size = 15)+
  ...
  labs(
    x="Weeks of the Calendar Year",
    y="Number of Hours Worked per Week"
  )+
  ylim(0,20)

ggsave("Proj_weeks.png",a,height=4,width=4,dpi=300)
knitr::include_graphics("Proj_weeks.png")
```
...
a <- data %>%
  ...
  theme(legend.background = element_rect(fill="transparent"))+
  labs(
    x="Months of Contract Completed",
